...
from src.GPT_SoVITS.text.symbols import punctuation
from src.GPT_SoVITS.text.tone_sandhi import ToneSandhi
...
if is_g2pw:
    ...
    from src.GPT_SoVITS.text.g2pw import G2PWPinyin, correct_pronunciation
    parent_directory = os.path.dirname(current_file_path)
    g2pw = G2PWPinyin(model_dir="src/GPT_SoVITS/text/G2PWModel",model_source="src/GPT_SoVITS/pretrained_models/chinese-roberta-wwm-ext-large",v_to_u=False, neutral_tone_with_five=True)
